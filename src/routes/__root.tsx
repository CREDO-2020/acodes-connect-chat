...
const themeScript = `(function(){try{var t=localStorage.getItem('acodes-theme');if(!t){t=window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light';}if(t==='dark'){document.documentElement.classList.add('dark');}}catch(e){}})();`;
    ...
    <div className="bg-aurora flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This page isn&apos;t part of Acodes, or it has moved.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Acodes — private class communication" },
      {
        name: "description",
        content:
          "Acodes is a private, real-time communication space for classmates: chats, groups, calls, resources and class announcements.",
      },
      { property: "og:site_name", content: "Acodes" },
